...
configure_dnsmasq() {
    ...
    wget -O /root/updateHosts.sh https://github.com/meramsey/softether-vpn-server-with-adblocking/raw/master/updateHosts.sh
...
configure_cron_jobs() {
    ...
    wget -O /root/softetherlogpurge.sh https://github.com/meramsey/softether-vpn-server-with-adblocking/raw/master/softetherlogpurge.sh
...
download_iptables_scripts() {
    ...
    wget -O /root/softether-iptables.sh https://github.com/meramsey/softether-vpn-server-with-adblocking/raw/master/softether-iptables.sh
    chmod +x /root/softether-iptables.sh
    wget -O /root/client_ports_iptables_conf.sh https://github.com/meramsey/softether-vpn-server-with-adblocking/raw/master/client_ports_iptables_conf.sh
